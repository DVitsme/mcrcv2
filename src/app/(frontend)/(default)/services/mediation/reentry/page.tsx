...
const sectionData = {
  title:
    'Re-Entry Mediation offers a compassionate space for families to come together and prepare for this next chapter. It’s a voluntary, confidential, and guided conversation, led by two neutral, trained mediators. where everyone has the chance to speak, listen, and be heard with respect.',
  subtitle:
...
export default function Reentry() {
  ...
  return (
    <main>
      <PageHero
        heading="Re-Entry Mediation"
        description="For people currently at the Howard County Detention Center or recently returning home, mediation is a chance for people to sit down with family or friends and talk about what coming home will look like. These conversations happen in private where participants can share hopes, concerns, and expectations."
        color="blue"
        image={{
          src: '/images/mediation/coupleoncouch.jpeg',
          alt: 'Re-Entry Mediation',
        }}
        badge="Re-Entry Mediation"
        buttons={{
          primary: {
            text: 'How it works',
