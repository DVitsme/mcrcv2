    ...
    <section className="py-32">
      <div className="container mx-auto">
        <div className="flex justify-center">
          <div
            className={`flex flex-col items-start justify-between gap-8 rounded-lg bg-${color} px-6 py-10 md:flex-row lg:px-20 lg:py-16`}
          >
            <div className="md:w-1/2">
              <h4 className="mb-6 text-2xl font-bold md:text-3xl">{title}</h4>
