    ...
    return {
      ...
      suggestion: {
        ...
        allow: ({ state, range }) => {
          ...
          // TS-safe lookup: schema.nodes[this.name] can be undefined
          const nodeType = state.schema.nodes[this.name as keyof typeof state.schema.nodes]

          if (!nodeType) return false

          return !!$from.parent.type.contentMatch.matchType(nodeType)
        },
      },
    }
  },
