...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_preferred_case_types" AS ENUM('mediation', 'restorative_justice');
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'coordinator', 'mediator', 'volunteer', 'participant');
  CREATE TYPE "public"."enum_users_user_status" AS ENUM('pending', 'active', 'rejected');
  CREATE TYPE "public"."enum_events_meta_status" AS ENUM('draft', 'published', 'completed', 'cancelled', 'archived');
  CREATE TYPE "public"."enum_events_modality" AS ENUM('in_person', 'online', 'hybrid');
  CREATE TYPE "public"."enum_cases_participants_role_in_case" AS ENUM('participant_1', 'participant_2', 'other_involved_party');
  CREATE TYPE "public"."enum_cases_status" AS ENUM('new', 'under_review', 'awaiting_participant_2', 'p2_response_received', 'p2_declined_pending_closure', 'awaiting_mediator_assignment', 'awaiting_consent', 'scheduled', 'in_progress', 'follow_up_required', 'on_hold', 'closed_resolved_agreement', 'closed_resolved_no_agreement', 'closed_unresolved', 'closed_rejected_intake', 'closed_p2_declined', 'closed_other');
  CREATE TYPE "public"."enum_cases_main_category" AS ENUM('Mediation', 'Restorative Justice');
  ...
  CREATE TABLE IF NOT EXISTS "users_languages_spoken" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"language" varchar
  ...
  CREATE TABLE IF NOT EXISTS "users_preferred_case_types" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_users_preferred_case_types",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "users" (
  	...
  	"user_status" "enum_users_user_status" DEFAULT 'pending',
  	"avatar_id" integer,
  	"bio" varchar,
  	"phone_number" varchar,
  	"is_available_for_new_cases" boolean DEFAULT false,
  	"contact_preferences_opt_in_new_case_notifications" boolean DEFAULT false,
  	"demographics_age" numeric,
  	"demographics_race_ethnicity" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "events_blocks_text_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "events_blocks_image_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "events_speakers" (
  	...
  	"speaker_bio" varchar,
  	"speaker_avatar_id" integer
  );
  
  CREATE TABLE IF NOT EXISTS "events" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  	"meta_status" "enum_events_meta_status" DEFAULT 'draft' NOT NULL,
  	"meta_event_type" varchar,
  	"meta_slug" varchar,
  	"summary" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "cases_mediators" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "cases_participants" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"participant_id" integer NOT NULL,
  	"role_in_case" "enum_cases_participants_role_in_case" NOT NULL,
  	"consent_form_link" varchar,
  	"consent_form_signed_at" timestamp(3) with time zone,
  	"notes" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "cases" (
  	...
  	"status" "enum_cases_status" DEFAULT 'new' NOT NULL,
  	"main_category" "enum_cases_main_category",
  	"case_subtype" varchar,
  	"participant1_full_name" varchar,
  	"participant1_email" varchar,
  	"participant1_phone" varchar,
  	"participant1_conflict_description" varchar,
  	"participant1_desired_outcome" varchar,
  	"participant2_full_name" varchar,
  	"participant2_email" varchar,
  	"participant2_phone" varchar,
  	"participant2_relationship_to_p1" varchar,
  	"p2_willing_to_mediate" boolean,
  	"conflict_description_by_p2" varchar,
  	"assigned_coordinator_id" integer,
  	"coordinator_notes" varchar,
  	"mediator_notes" varchar,
  	"public_notes" varchar,
  	"rejection_closure_reason" varchar,
  	"rejection_closure_details" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "users_languages_spoken" ADD CONSTRAINT "users_languages_spoken_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "users_preferred_case_types" ADD CONSTRAINT "users_preferred_case_types_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "events_blocks_text_block" ADD CONSTRAINT "events_blocks_text_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."events"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "events_speakers" ADD CONSTRAINT "events_speakers_speaker_avatar_id_media_id_fk" FOREIGN KEY ("speaker_avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "cases_mediators" ADD CONSTRAINT "cases_mediators_mediator_id_users_id_fk" FOREIGN KEY ("mediator_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "cases_mediators" ADD CONSTRAINT "cases_mediators_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."cases"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "cases_participants" ADD CONSTRAINT "cases_participants_participant_id_users_id_fk" FOREIGN KEY ("participant_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "cases_participants" ADD CONSTRAINT "cases_participants_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."cases"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "cases" ADD CONSTRAINT "cases_assigned_coordinator_id_users_id_fk" FOREIGN KEY ("assigned_coordinator_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "users_languages_spoken_order_idx" ON "users_languages_spoken" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "users_languages_spoken_parent_id_idx" ON "users_languages_spoken" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "users_preferred_case_types_order_idx" ON "users_preferred_case_types" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "users_preferred_case_types_parent_idx" ON "users_preferred_case_types" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "users_avatar_idx" ON "users" USING btree ("avatar_id");
  CREATE INDEX IF NOT EXISTS "users_updated_at_idx" ON "users" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "users_created_at_idx" ON "users" USING btree ("created_at");
  CREATE UNIQUE INDEX IF NOT EXISTS "users_email_idx" ON "users" USING btree ("email");
  CREATE INDEX IF NOT EXISTS "events_blocks_text_block_order_idx" ON "events_blocks_text_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "events_blocks_text_block_parent_id_idx" ON "events_blocks_text_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "events_blocks_text_block_path_idx" ON "events_blocks_text_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "events_blocks_image_block_order_idx" ON "events_blocks_image_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "events_blocks_image_block_parent_id_idx" ON "events_blocks_image_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "events_blocks_image_block_path_idx" ON "events_blocks_image_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "events_blocks_image_block_image_idx" ON "events_blocks_image_block" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "events_speakers_speaker_avatar_idx" ON "events_speakers" USING btree ("speaker_avatar_id");
  CREATE INDEX IF NOT EXISTS "events_meta_meta_slug_idx" ON "events" USING btree ("meta_slug");
  ...
  CREATE INDEX IF NOT EXISTS "cases_mediators_order_idx" ON "cases_mediators" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "cases_mediators_parent_id_idx" ON "cases_mediators" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "cases_mediators_mediator_idx" ON "cases_mediators" USING btree ("mediator_id");
  CREATE INDEX IF NOT EXISTS "cases_participants_order_idx" ON "cases_participants" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "cases_participants_parent_id_idx" ON "cases_participants" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "cases_participants_participant_idx" ON "cases_participants" USING btree ("participant_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "cases_case_reference_id_idx" ON "cases" USING btree ("case_reference_id");
  CREATE INDEX IF NOT EXISTS "cases_assigned_coordinator_idx" ON "cases" USING btree ("assigned_coordinator_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "users_languages_spoken" CASCADE;
  DROP TABLE "users_preferred_case_types" CASCADE;
  DROP TABLE "users" CASCADE;
  DROP TABLE "events_blocks_text_block" CASCADE;
  DROP TABLE "events_blocks_image_block" CASCADE;
  DROP TABLE "events_speakers" CASCADE;
  DROP TABLE "events" CASCADE;
  DROP TABLE "cases_mediators" CASCADE;
  DROP TABLE "cases_participants" CASCADE;
  ...
  DROP TYPE "public"."enum_users_preferred_case_types";
  DROP TYPE "public"."enum_users_role";
  DROP TYPE "public"."enum_users_user_status";
  DROP TYPE "public"."enum_events_meta_status";
  DROP TYPE "public"."enum_events_modality";
  DROP TYPE "public"."enum_cases_participants_role_in_case";
  DROP TYPE "public"."enum_cases_status";
  DROP TYPE "public"."enum_cases_main_category";
